...
InfinityList comes with 5 taxa loaded to start with: plants, butterflies, cicadas, marsupials, and dragonflies+damselflies.  If you want to add another taxa of interest, you'll need to download the data first via the galah interface to the Atlas of Living Australia.  This is done in a few steps:
