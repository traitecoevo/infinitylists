      ...
      mainPanel(
        tabsetPanel(
          ...
          tabPanel("About",
                   ...
                   p("This app allows users to explore biodiversity across the world. After selecting a location and taxonomic group, the app will generate a species list."),
                   
                   h4("2. Which taxonomic groups can I generate lists for?"),
                   p("You can generate lists for demo taxon-country combinations in the browser-based Shiny app (e.g., plants in Australia or butterflies and moths in Peru), or download our R package (see below) and choose any taxon-country combination by using our app via R."),
                   ...
                   p("The data originate from herbaria, museums and the citizen science platform iNaturalist, generated by thousands of dedicated and skilled contributors. These data are curated by national and international organzations, which make it available to the app. All Australian data are extracted from the Atlas of Living Australia (ALA), Australia's", tags$a(href= "https://www.ala.org.au", "national biodiversity database."), "Data from the rest of the world are extracted from the ",
                   tags$a(href = "https://www.gbif.org", "Global Biodiversity Information Facility (GBIF).")),
